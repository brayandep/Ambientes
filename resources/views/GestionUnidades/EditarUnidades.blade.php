            ...
            <div class=registro>
                <form action="{{route('unidad.store')}}" method="POST">
                    ...
                    <div class="div1Label">
                            ...
                            <input class="imput" type="text" id="codigoUnidad" name="codigoUnidad" placeholder="Ingrese codigo de la unidad" minlength="8" maxlength="8" autocomplete="off" value="{{$unidad->codigoUnidad}}">
                            @error('codigoUnidad')
                                <span>*{{$message}}</span>
                            @enderror
                    ...
                    <div class="div2Seleccion">
                        <div class="seleccion">
                            ...
                            <select class="imput" id="Nivel" name="Nivel" value="{{$unidad->Nivel}}">
                        ...
                        <div class="seleccion">
                            ...
                            <select class="imput" id="Dependencia" name="Dependencia" value="{{$unidad->Dependencia}}">
